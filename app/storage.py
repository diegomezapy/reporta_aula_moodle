    ...
    return [
        {
            ...
            "heuristic_probability": row.heuristic_probability,
            "bayesian_prior_probability": row.bayesian_prior_probability,
            "bayesian_posterior_probability": row.bayesian_posterior_probability,
            "bayesian_log_likelihood_ratio": row.bayesian_log_likelihood_ratio,
            "bayesian_evidence_factors": "; ".join(row.bayesian_evidence_factors),
